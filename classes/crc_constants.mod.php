<?php
	...
	// APP_ Constants
	//******************************************************
	define('APP_PROJECTNAME', 'Student Management System');
	define('APP_DIVISION', 'SMS');
	define('APP_DEVELOPMENT_LEAD', 'SMS');
	define('APP_VERSION', '2.0.0');
	define('APP_CONTACT_NAME', 'Muhammad Abba Gana');
	define('APP_CONTACT_EMAIL', 'abbagana79@gmail.com');
	define('APP_COPYRIGHT', 'This application is copyright &copy; 2017. Use of any code in part or whole without the written concent of SMS  is prohibited and against the law.');
	define('APP_PATH', '/sms/');	
	...
	define('MYSQL_SESSIONS_TBL', 'crc_sessions');
	define('MYSQL_PROFILES_TBL', 'crc_profiles');
	define('MYSQL_ROLES_TBL', 'crc_roles');
	define('MYSQL_ATTENDANCE_TBL', 'crc_attendance');
	define('MYSQL_COURSES_TBL', 'crc_courses');
	define('MYSQL_DATE_TBL', 'crc_date');
	define('MYSQL_ROOMS_TBL', 'crc_rooms');
	define('MYSQL_SCHEDULE_TBL', 'crc_schedule');
	define('MYSQL_STUDENT_SCHEDULE_TBL', 'crc_student_schedule');
	define('MYSQL_TEACHER_SCHEDULE_TBL', 'crc_teacher_schedule');
	define('MYSQL_VENUE_TBL', 'crc_venue');
	define('MYSQL_FEEDBACK_TBL', 'crc_feedback');
	define('MYSQL_FEEDBACK_QUESTIONS_TBL', 'crc_feedback_questions');
	define('MYSQL_FEEDBACK_ANSWERS_TBL', 'crc_feedback_answers');
